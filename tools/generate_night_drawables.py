...
RULES = {
    XXHDPI: {
        ...
        "sb_tabbar_bg_down.png": multiply_to((35, 38, 43), base=245),
        "secondary_bar.9.png": multiply_to(TITLE_BAR, base=242),
        ...
        "dropdown_menu_favorite_add.png": whiteify(),
        "dropdown_menu_favorite_add_down.png": whiteify(),
        "dropdown_menu_musiclose.png": whiteify(),
        "dropdown_menu_musiclose_down.png": whiteify(),
        "dropdown_menu_next.png": whiteify(),
        "dropdown_menu_next_down.png": whiteify(),
        "dropdown_menu_play.png": whiteify(),
        "dropdown_menu_play_down.png": whiteify(),
        "dropdown_menu_prev.png": whiteify(),
        "dropdown_menu_prev_down.png": whiteify(),
        "dropdown_menu_music_line.9.png": whiteify(),
        ...
        "standard_btn_normal.9.png": whiteify(),
        "standard_btn_pressed.9.png": whiteify(),
        "standard_btn_disabled.9.png": whiteify(),
    ...
    NODPI: {
        ...
        "more_select_titlebar_bg.png": multiply_to(TITLE_BAR, base=251),
        "more_select_btn_bg.png": multiply_to(SURFACE, base=242),
        "local_more_select_btn_bg.png": multiply_to(SURFACE, base=242),
        ...
        "more_select_icon_ringtone.png": whiteify(),
        ...
        "btn_cancel.9.png": whiteify(),
        "btn_cancel_down.9.png": whiteify(),
        "btn_shuffle3.png": whiteify(),
